...
var analyticInstance$ = (0, import_rxjs.timer)(0, 300).pipe((0, import_operators.concatMap)(() => (0, import_rxjs.from)(ɵgetAllInstancesOf(ANALYTICS_PROVIDER_NAME))), (0, import_operators.distinct)());
...
var ɵscreenViewEvent = (router, title, componentFactoryResolver) => {
  const activationEndEvents = router.events.pipe((0, import_operators.filter)((e) => e instanceof ActivationEnd));
  return activationEndEvents.pipe((0, import_operators.switchMap)((activationEnd) => {
    ...
    if (typeof component === "string") {
      return (0, import_rxjs.of)(__spreadProps(__spreadValues({}, params), {
    ...
    return (0, import_rxjs.of)(null);
  }), (0, import_operators.filter)((it) => !!it), (0, import_operators.map)((params) => __spreadValues({
    [FIREBASE_SCREEN_CLASS_KEY]: params[SCREEN_CLASS_KEY],
    [FIREBASE_SCREEN_INSTANCE_ID_KEY]: getScreenInstanceID(params)
  }, params)), (0, import_operators.groupBy)((it) => it[OUTLET_KEY]), (0, import_operators.mergeMap)((it) => it.pipe((0, import_operators.distinctUntilChanged)((a, b) => JSON.stringify(a) === JSON.stringify(b)), (0, import_operators.startWith)(void 0), (0, import_operators.pairwise)(), (0, import_operators.map)(([prior, current]) => prior ? __spreadValues({
  ...
  constructor(router, title, componentFactoryResolver, zone, userTrackingService, injector) {
    ...
    isSupported2().then(() => {
      ...
      zone.runOutsideAngular(() => {
        this.disposable = ɵscreenViewEvent(router, title, componentFactoryResolver).pipe((0, import_operators.switchMap)((params) => __async(this, null, function* () {
