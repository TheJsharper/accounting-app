...
function getStreamInternal(ref2, maxDownloadSizeBytes) {
  ref2._throwIfRoot("getStream");
  const requestInfo = getBytes$1(ref2.storage, ref2._location, maxDownloadSizeBytes);
  ...
  ref2.storage.makeRequestWithTokens(requestInfo, newStreamConnection).then((readableStream) => readableStream.pipeThrough(result)).catch((err) => result.writable.abort(err));
...
function getStream(ref2, maxDownloadSizeBytes) {
  ref2 = getModularInstance(ref2);
  return getStreamInternal(ref2, maxDownloadSizeBytes);
}
...
@firebase/storage/dist/node-esm/index.node.esm.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-GXUMWHP7.js.map
